...
static int inline i2c_send(const ssd1306_t *dev, uint8_t reg, uint8_t* data, uint8_t len)
{
    ...
    esp_err_t ret=i2c_master_write_byte(cmd, dev->i2c_addr << 1 | I2C_MASTER_WRITE, true);
...
int ssd1306_init(const ssd1306_t *dev)
{
	...
	ssd1306_command(dev,0x20);
	ssd1306_command(dev,0x0);
	ssd1306_command(dev,0x40);
	ssd1306_command(dev,0xa1);
	ssd1306_command(dev,0xa8);
	ssd1306_command(dev,0x3f);
	ssd1306_command(dev,0xc8);
	ssd1306_command(dev,0xd3);
	ssd1306_command(dev,0x0);
	ssd1306_command(dev,0xda);
	ssd1306_command(dev,0x12);
	ssd1306_command(dev,0xd5);
	ssd1306_command(dev,0x80);
	ssd1306_command(dev,0xd9);
	ssd1306_command(dev,0xf1);
	ssd1306_command(dev,0xdb);
	ssd1306_command(dev,0x30);
	ssd1306_command(dev,0x81);
